...
mean(subset(gapminder, continent == 'Asia', select = lifeExp))
dim(subset(gapminder, continent == 'Asia', select = lifeExp))

subset(gapminder, continent == 'Asia', select = lifeExp) %>%
  ggplot(aes(x = lifeExp)) + geom_density(fill = 'green',
                                          alpha = 0.5) + 
...
group_by(gapminder, continent == 'Asia') %>%
  ...
  ggplot(aes(x = lifeExp)) + geom_density(fill = 'green',
                                          alpha = 0.5) + 
  geom_vline(xintercept = mean(subset(gapminder,
                                      continent == 'Asia',
                                      select = lifeExp)))
